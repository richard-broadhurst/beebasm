...
public:
	...
	void dump_callstack(int pc);
	void dump_callstack(LineParser * lp);
	void dump_callstack(LineParser * lp, int pc);
};
...
public:																			\
	...
	explicit AsmException_AssembleError_##a(int lp) {dump_callstack(lp);}	\
	AsmException_AssembleError_##a(LineParser * line) {dump_callstack(line);}	\
	AsmException_AssembleError_##a(LineParser * line, int pc) {dump_callstack(line, pc);}	\
